...
files = glob.glob("./tmp_files/img_*.png")
files.sort()
...
for cnt, f in enumerate(files):
    ...
    cv2.imshow("img", img)
    cv2.imwrite("conc_%08d.png" % cnt, img)
